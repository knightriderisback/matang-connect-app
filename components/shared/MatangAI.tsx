...
export function MatangAI() {
  ...
  const fabClass = isSuper
    ? "fixed bottom-16 left-3 md:bottom-20 md:left-6 z-30 flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-purple-700/75 to-indigo-900/75 text-amber-300 shadow-lg shadow-purple-900/30 ring-1 ring-purple-400/40 backdrop-blur-sm"
    : "fixed bottom-16 left-3 md:bottom-20 md:left-6 z-30 flex items-center justify-center w-14 h-14 rounded-full bg-matang-navy/75 text-matang-gold shadow-lg ring-1 ring-matang-gold/40 backdrop-blur-sm";
