  ...
  return (
    <div className="min-h-screen bg-matang-cream flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-20">
        <div className="w-24 h-24 bg-matang-gold rounded-3xl flex items-center justify-center mb-6 shadow-xl">
          <span className="text-5xl">🪷</span>
        </div>
        <h1 className="text-3xl font-bold text-matang-navy mb-2 text-center">{t("app.name")}</h1>
        <p className="text-gray-500 text-center mb-8 max-w-xs">{t("app.tagline")} — A digital ecosystem for the Matang community</p>
        ...
        <p className="mt-6 text-xs text-gray-400 text-center">Pilot: Bilaspur, Chhattisgarh<br/>Zero-cost • Mobile-only • AI-assisted</p>
      </div>
    </div>
  );
}
